...
if __name__ == "__main__":
    pswd = Password()
    pswd.config('_xxxp@ssw0rdxxx_')
    pswd2 = Password()
    pswd2.config('_K30n-Fo$tEr_')
    pswd3 = Password()
    pswd3.config('HelloWorld')
    print(pswd.entropy, pswd.security_score, pswd.get_password_strength())
    print(pswd2.entropy, pswd2.security_score, pswd2.get_password_strength())
    print(pswd3.entropy, pswd3.security_score, pswd3.get_password_strength())
